...
so that similar results are produced in documents. To use this, make sure the
`skimmed` object is the last item in your code chunk.
...
"Chinese"). The helper function`fix\_windows\_histograms()\` does this for you.
