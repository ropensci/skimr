...
These build on the [pander package](https://cran.r-project.org/web/packages/pander/index.html)
and the kable function of the [knitr package](https://cran.r-project.org/web/packages/knitr/index.html)
These examples show how the enhanced options appear in the console.
Note that the `skimr::` names space is used to prevent it being
