...
function. This can be added for backwards compatibility.
...
functions by using the reshaping functions described above to get subtables.
...
the `skimr` developers have other priorities. Michael's family added a new baby,
and despite swearing up and down otherwise, he got absolutely nothing
