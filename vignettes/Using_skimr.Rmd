...
If an individual column is of an unsuppported class it is treated as a character variable 
with a warning.
...
coerce it to  character (with a warning) and report number of `NA`s, number complete
