...
test_that("skim returns expected response for numeric vectors", {
  ...
  expect_named(input, c("variable", "type", "missing", "complete", "n", "mean",
  ...
  # values
  expect_identical(input$variable, "mpg")
  expect_identical(input$type, "numeric")
...
test_that("skim handles numeric vectors with NAs and extreme numbers", {
  ...
  # values
  expect_identical(input$variable, "vals")
  expect_identical(input$type, "numeric")
...
test_that("numeric skim is calculated correctly when x is all NAs.", {
  ...
  # values
  expect_identical(input$variable, "nas")
  expect_identical(input$type, "numeric")
...
test_that("numeric skim is calculated correctly when x is all zeores or NAs.", {
  ...
  # values
  expect_identical(input$variable, "na_and_zeros")
  expect_identical(input$type, "numeric")
  expect_identical(input$missing, 3L)
...
test_that("Skimming with non-finite values works", {
  ...
  expect_identical(input$variable, "inf_vals")
  expect_identical(input$type, "numeric")
  expect_identical(input$missing, 0L)
...
test_that("skim returns expected response for factor vectors", {
  ...
  expect_equal(attrs$skimmers_used,
               list(factor = c("missing", "complete", "n", "ordered",
                               "n_unique", "top_counts")))

  # values
  expect_identical(input$variable, "Species")
  expect_identical(input$type, "factor")
  expect_identical(input$missing, 0L)
...
test_that("skim returns expected response for character vectors", {
  ...
  expect_is(input, "tbl")
  expect_is(input, "data.frame")
  expect_named(input, c("variable", "type", "missing", "complete", "n", "min",
                        "max", "empty", "n_unique"))
  ...
  expect_equal(attrs$df_name, "`x`")
  expect_equal(attrs$skimmers_used,
               list(character = c("missing", "complete", "n", "min", "max",
                                  "empty", "n_unique")))
...
test_that("skim returns expected response for logical vectors", {
  ...
  # values
  expect_identical(input$variable, "log_col")
  expect_identical(input$type, "logical")
  expect_identical(input$missing, 0L)
...
test_that("skim returns expected response for complex vectors", {
  ...
  # values
  expect_identical(input$variable, "test_complex")
  expect_identical(input$type, "complex")
  expect_identical(input$missing, 4L)
  expect_identical(input$complete, 67L)
  expect_identical(input$n, 71L)
})
...
test_that("skim returns expected response for Date vectors", {
  ...
  expect_equal(attrs$df_name, "`x`")
  expect_equal(attrs$skimmers_used,
               list(Date = c("missing", "complete", "n", "min", "max",
                             "median", "n_unique")))

  # values
  expect_identical(input$variable, "dat")
  expect_identical(input$type, "Date")
  expect_identical(input$missing, 0L)
...
test_that("skim returns expected response for ts vectors", {
  ...
  expect_is(input, "tbl")
  expect_is(input, "data.frame")
  expect_named(input, c("variable", "type", "missing", "complete", "n", "start",
  ...
  expect_equal(attrs$skimmers_used,
               list(ts = c("missing", "complete", "n", "start", "end",
                           "frequency", "deltat", "mean", "sd", "min",
                           "max", "median", "line_graph")))

  # values
  expect_identical(input$variable, "y")
  expect_identical(input$type, "ts")
  expect_identical(input$missing, 0L)
...
test_that("skim returns expected response for POSIXct vectors", {
  ...
  expect_equal(attrs$skimmers_used,
               list(POSIXct = c("missing", "complete", "n", "min", "max",
                                "median", "n_unique")))

  # values
  expect_identical(input$variable, "dat")
  expect_identical(input$type, "POSIXct")
  expect_identical(input$missing, 1L)
  expect_identical(input$complete, 9L)
...
test_that("skim returns expected response for list (not AsIs) vectors", {
  ...
  expect_equal(attrs$skimmers_used,
               list(list = c("missing", "complete", "n", "n_unique",
                             "min_length", "max_length")))

  # values
  expect_identical(input$variable, "dat")
  expect_identical(input$type, "list")
  expect_identical(input$missing, 1L)
...
test_that("skim returns expected response for asis vectors", {
  ...
  expect_equal(attrs$skimmers_used,
               list(AsIs = c("missing", "complete", "n", "n_unique",
                             "min_length", "max_length")))

  # values
  expect_identical(input$variable, "dat")
  expect_identical(input$type, "AsIs")
  expect_identical(input$missing, 1L)
  expect_identical(input$complete, 3L)
  expect_identical(input$n, 4L)
...
test_that("skim returns expected response for difftime vectors", {
  ...
  expect_equal(attrs$skimmers_used,
               list(difftime = c("missing", "complete", "n", "min", "max",
                                 "median", "n_unique")))

  # values
  expect_identical(input$variable, "dat")
  expect_identical(input$type, "difftime")
  expect_identical(input$missing, 1L)
  expect_identical(input$complete, 9L)
  expect_identical(input$n, 10L)
...
test_that("skim treats unknown classes as character", {
  ...
  # values
  expect_identical(input$variable, "weight")
  expect_identical(input$type, "character")
})
...
test_that("skim handles objects with two unknown classes", {
  ...
  # values
  expect_identical(input$variable, "feed")
  expect_identical(input$type, "character")
})
...
test_that("Tidyselect helpers work as expected", {
  ...
  expect_n_rows(input, 2)
  expect_n_columns(input, 13)
  expect_identical(input$variable, c("Sepal.Length", "Sepal.Width"))
})
...
test_that("Skimming a grouped df works as expected", {
  ...
  expect_is(input, "tbl")
  expect_is(input, "data.frame")
  expect_named(input, c("variable", "type", "cyl", "gear", "missing",
