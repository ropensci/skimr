...
test_that("skimr::pander prints as expected", {
  ...
  expect_equal(input[6], " variable   missing   complete   n    n_unique           top_counts         ")
  expect_equal(input[7], "---------- --------- ---------- ---- ---------- ----------------------------")
  expect_equal(input[8], "   feed        0         71      71      6       soy: 14, cas: 12, lin: 12, ")
  expect_equal(input[9], "                                                          sun: 12           ")
  expect_equal(input[10], "----------------------------------------------------------------------------")
  ...
  expect_equal(input[23], " variable   missing   complete   n     mean     sd     min    p25    median ")
  expect_equal(input[24], "---------- --------- ---------- ---- -------- ------- ----- ------- --------")
  expect_equal(input[25], "  weight       0         71      71   261.31   78.07   108   204.5    258   ")
