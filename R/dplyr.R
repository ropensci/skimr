#' Mutate a skim_df
#'
#' \code{\link[dplyr]{mutate}} currently drops attributes, but we need to keep them around
...
#'  \code{\link[rlang]{quo}} and evaluated with \code{\link[rlang]{eval_tidy}} 
#'   in the context of the data frame. They
#'   support unquoting \code{\link[rlang]{quasiquotation}} and splicing. See
...
#' @seealso \code{\link[dplyr]{mutate}} for the function's expected behavior.
